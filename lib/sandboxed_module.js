...
SandboxedModule.prototype._getSourceTransformers = function() {
  var userTransformers = this._options.sourceTransformers || {};
  return Object.keys(userTransformers).reduce(function(memo, transformerName){
    memo[transformerName] = userTransformers[transformerName];
    return memo;
  }, getStartingSourceTransformers());
};
